...
`runtime_error` exceptions report error conditions outside the program's scope.
 ...
 - `system_error`: This exception reports that the operating system encountered an error. This can be particular useful to catch as it'll include a lot of details about the nature of the error. To use this exception, include the 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5NjQ1NjE4OCwyNzkwOTUyMTMsMjA0Nj
